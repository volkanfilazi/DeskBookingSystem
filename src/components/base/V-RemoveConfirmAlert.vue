...
<template>
  <Teleport to="#removeConfirmModalTeleport">
    <Transition name="fade">
      <div v-show="prop.open" class="fixed flex justify-center items-center left-0 top-0 right-0 bottom-0 z-100">
        <div class="absolute w-full h-full bg-black opacity-75" @click.self="emit('close', true)"></div>
        <div class="border-[1px] border-gray-600 min-w-[280px] min-h-[200px] bg-gray-800 p-2 rounded-lg z-10">
